...
public class ConfigurationPropertiesBean {
	...
	private String nomadWsHeader;
	
	private String nomadWsToken;
	
	private String nomadWsBaseUrl;
	...
	public String getNomadWsHeader() {
		return nomadWsHeader;
	}
	public void setNomadWsHeader(String header) {
		this.nomadWsHeader = header;
	}
	
	public String getNomadWsToken() {
		return nomadWsToken;
	}
	public void setNomadWsToken(String token) {
		this.nomadWsToken = token;
	}
	
	public String getNomadWsBaseUrl() {
		return nomadWsBaseUrl;
	}
	public void setNomadWsBaseUrl(String baseUrl) {
		this.nomadWsBaseUrl = baseUrl;
	}
	
	public String getNomadLoginUrl() {
		return nomadLoginUrl;
	}
	public void setNomadLoginUrl(String nomadRootUrl) {
