...
<!-- <div class="navbar navbar-fixed-top"> -->
	<div class="navbar-inner">
		<div class="container">
			...
			<!-- <div class='nav-collapse collapse' id='mainnav-collapse'>
				<ul class='nav pull-right'>
				<li>
				<a href="/log_in"><i class="icon-lock icon-white"></i>
				Login
				</a></li>
				</ul>
			</div> -->
					...
					<ul class="nav pull-right visible-desktop">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu pull-right">
								...
								<li class="divider"></li>
								<li><a href="" class="logoutLink" data-toggle="collapse" data-target=".nav-collapse"><i class="icon-remove"></i> <spring:message code="topbar.logout"/></a></li>
							</ul>
						</li>
	                    </security:authorize>
	                    <security:authorize access="!hasRole('ROLE_USER')">
